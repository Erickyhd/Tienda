...
<div class="row visible-print-block">
    <h2 class="text-center">Reporte sobre ventas</h2>
</div>
...
<div class="row">
    <div class="col-xs-4">
        <h3 class="text-center" hidden="hidden"><strong>Total:</strong> S/<span id="mostrar_total"></span></h3>
    </div>
    <div class="col-xs-4">
        <h3 class="text-center" hidden="hidden"><strong>Invertido:</strong> S/<span id="mostrar_invertido"></span></h3>
    </div>
    <div class="col-xs-4">
        <h3 class="text-center" hidden="hidden"><strong>Utilidad:</strong> S/<span id="mostrar_utilidad"></span></h3>
    </div>
</div>

<div class="row"><br>
    <div class="col-xs-12 col-sm-12 col-md-3">
        <h4 class="text-center">Por familia</h4>
